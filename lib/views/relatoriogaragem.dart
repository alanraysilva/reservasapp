...
class RelatorioGaragem extends StatefulWidget {
  const RelatorioGaragem({Key? key}) : super(key: key);

  @override
  State<RelatorioGaragem> createState() => _RelatorioGaragemState();
}

class _RelatorioGaragemState extends State<RelatorioGaragem> {
    ...
    pdf.addPage(pw.MultiPage(
        ...
        build: (pw.Context context) => <pw.Widget>[
          ...
          pw.Table.fromTextArray(
              ...
              data: <List<String>>[
                <String>['Garagem','Entrada','Saida','Ap','Inquilino'],
                for (int i = 0; i < mdl.length; i++)
                  <String>[verificaGaragem(mdl[i].objGaragem),
                    '${DataUtil.formataDataComDiaExtensoSemHora(mdl[i].entrada)}',
